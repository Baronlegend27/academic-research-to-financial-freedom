...
\[ \bar{\lambda}_{1} = \frac{1}{T} \sum_{t=1}^{T} \lambda_{1,t} \] If \( \bar{\lambda}_{1} \) is statistically significant (based on a t‑test), then the factor is considered a valid driver of cross‑sectional returns.
